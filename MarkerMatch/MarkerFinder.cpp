...
//vecFoud表示返回的检测结果;
void CMarkerFinder::LocateCrossAreaByHog(Mat srcImg, double dHitThre, bool bHollowCross, vector<LocMarker> & vecFound) {
...
bool CMarkerFinder::LocateTemplate(Mat srcImg, Mat tempImg, int nMaxCount, vector<LocMarker> & vecTempRect) {
	...
	//equalizeHist(srcGrayImg, srcGrayImg);
	//imwrite("d:\\equlizad.jpg", srcGrayImg);
...
bool CMarkerFinder::LocateMarkerByTempMatch(Mat srcImg, Mat templateImg,vector<Rect> vecMarkerAreaRect,
